  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 pt-20 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-2 sm:p-4 lg:p-4 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
            ...
            <div className="flex flex-col justify-between">
              <div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-3 sm:mb-3">
                  {product.name}
                </h1>
                ...
                <div className="mb-6 sm:mb-8">
                  ...
                  <p className="text-xl sm:text-xl lg:text-2xl font-bold text-[#2573E6]">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-[#2573E6] to-blue-600 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-2 sm:py-3 px-6 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                >
