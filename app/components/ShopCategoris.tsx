    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="my-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        <div className="flex flex-col bg-white rounded-lg shadow-md pb-4">
          ...
          <p className="text-gray-600 px-3 text-sm">124 Items</p>
        </div>
        ...
        <div className="flex flex-col bg-white rounded-lg shadow-md pb-4">
          ...
          <p className="text-gray-600 px-3 text-sm">56 Items</p>
        </div>
        ...
        <div className="flex flex-col bg-white rounded-lg shadow-md pb-4">
          <img
            ...
            className="w-full h-60 object-cover rounded-t-lg mb-6"
          />
          <h1 className="text-lg font-semibold px-3">Table Fan</h1>
          <p className="text-gray-600 px-3 text-sm">32 Items</p>
        </div>
